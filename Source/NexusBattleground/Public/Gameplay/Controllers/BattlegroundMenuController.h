...
#include "BattlegroundMenuController.generated.h"
...
UCLASS()
class NEXUSBATTLEGROUND_API ABattlegroundMenuController : public APlayerController
{
	GENERATED_BODY()
...
#pragma region Constructors and Overrides
	ABattlegroundMenuController(const FObjectInitializer& objectInitializer);
