...
#include "BattlegroundAIController.h"
...
ABattlegroundAIController::ABattlegroundAIController(const FObjectInitializer& objectInitializer) : Super(objectInitializer)
{
}
