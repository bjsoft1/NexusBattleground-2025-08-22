...
#include "SoloDeathmatchGameMode.h"
...
ASoloDeathmatchGameMode::ASoloDeathmatchGameMode(const FObjectInitializer& objectInitializer) : Super(objectInitializer, EGameModes::GM_SDM)
{
}
