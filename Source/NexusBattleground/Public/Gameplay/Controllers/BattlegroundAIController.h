...
#include "BattlegroundAIController.generated.h"
...
UCLASS()
class NEXUSBATTLEGROUND_API ABattlegroundAIController : public AAIController
{
	GENERATED_BODY()
...
#pragma region Constructors and Overrides
	ABattlegroundAIController(const FObjectInitializer& objectInitializer);
...
#pragma region Components
	TSubclassOf<AController> ComputerControllerClass;
