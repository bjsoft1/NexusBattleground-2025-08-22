...
#include "SoloDeathmatchGameMode.generated.h"
...
UCLASS()
class NEXUSBATTLEGROUND_API ASoloDeathmatchGameMode : public ABattlegroundGameMode
{
	GENERATED_BODY()
...
#pragma region Constructors and Overrides
	ASoloDeathmatchGameMode(const FObjectInitializer& objectInitializer);
