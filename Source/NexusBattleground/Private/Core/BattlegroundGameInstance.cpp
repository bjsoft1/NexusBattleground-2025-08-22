...
UBattlegroundGameInstance::UBattlegroundGameInstance(const FObjectInitializer& objectInitializer) : Super(objectInitializer)
{

}
void UBattlegroundGameInstance::Init()
{
	Super::Init();

	this->SettingsManager = NewObject<UBattlegroundSettingsManager>(this, UBattlegroundSettingsManager::StaticClass());
