...
#include "SearchDestroyGameMode.generated.h"
...
UCLASS()
class NEXUSBATTLEGROUND_API ASearchDestroyGameMode : public ABattlegroundGameMode
{
	GENERATED_BODY()
...
#pragma region Constructors and Overrides
	ASearchDestroyGameMode(const FObjectInitializer& objectInitializer);
