...
#include "SearchDestroyGameMode.h"
...
ASearchDestroyGameMode::ASearchDestroyGameMode(const FObjectInitializer& objectInitializer) : Super(objectInitializer, EGameModes::GM_SD)
{
}
